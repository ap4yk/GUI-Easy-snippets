...
public class CWDetails extends JFrame implements ActionListener, KeyListener {
    ...
    private void view() {
        ...
        JLabel cenLbl = new JLabel("<html><body>Hello nice people :-)</body></html>");
        cenLbl.setFont(fnt);
        cen.add(cenLbl);
        add(cen, BorderLayout.CENTER);

        JPanel rgt = new JPanel();
        rgt.setLayout(new FlowLayout());
        JLabel rt = new JLabel("<html><body>East</body></html>");
        rt.setFont(fnt);
        rgt.add(rt);
        ...
        JLabel copy = new JLabel("<html><body>Copyright (c) Andy Wicks 2016</body></html>");
        copy.setFont(fnt);
        bot.add(copy);
